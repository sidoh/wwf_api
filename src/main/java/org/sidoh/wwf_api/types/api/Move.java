...
public class Move implements org.apache.thrift.TBase<Move, Move._Fields>, java.io.Serializable, Cloneable {
  ...
  public Move setBoardChecksum(int boardChecksum) {
    this.boardChecksum = boardChecksum;
    setBoardChecksumIsSet(true);
    return this;
  }
  ...
  public Move setCreatedAt(String createdAt) {
    this.createdAt = createdAt;
    return this;
  }
  ...
  public Move setPlayStartPosition(Coordinates playStartPosition) {
  ...
  public Move setPlayEndPosition(Coordinates playEndPosition) {
  ...
  public Move setGameId(long gameId) {
    this.gameId = gameId;
    setGameIdIsSet(true);
    return this;
  }
  ...
  public Move setMoveIndex(int moveIndex) {
    this.moveIndex = moveIndex;
    setMoveIndexIsSet(true);
    return this;
  }
  ...
  public Move setPoints(int points) {
    this.points = points;
    setPointsIsSet(true);
    return this;
  }
  ...
  public Move setPromoted(int promoted) {
  ...
  public Move setWords(List<String> words) {
    this.words = words;
    return this;
  }
  ...
  public Move setText(String text) {
    this.text = text;
    return this;
  }
   ...
   * were either played or swapped.
   */
  public Move setTiles(List<org.sidoh.wwf_api.types.game_state.Tile> tiles) {
    this.tiles = tiles;
    return this;
  }
